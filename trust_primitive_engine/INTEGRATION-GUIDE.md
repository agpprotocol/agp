# TPE 2.3 Integration Guide

This guide explains how an external system can integrate with the AGP Trust
Primitive Engine (TPE) 2.3 through its command-line interface.
...
A complete TPE 2.3 evaluation can require four JSON inputs:
...
TPE 2.3 verifies signatures against the supplied keyring. The keyring itself is
...
## 16. Security requirements for integrators
...
## 18. Recommended integration workflow
