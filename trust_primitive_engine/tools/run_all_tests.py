...
SUITES = [
    ...
    (
        "release attestation verification contract",
        ROOT
        / "trust_primitive_engine/tools/"
        "test_release_attestation_verification_contract.py",
        20,
    ),
    (
    ...
    (
        "release candidate preparation contract",
        ROOT
        / "trust_primitive_engine/tools/"
        "test_release_candidate_preparation_contract.py",
        20,
    ),
    (
    ...
    (
        "controlled remote tag publication contract",
        ROOT
        / "trust_primitive_engine/tools/"
        "test_controlled_remote_tag_publication_contract.py",
        20,
    ),
    (
    ...
    (
        "draft publication authorization contract",
        ROOT
        / "trust_primitive_engine/tools/"
        "test_draft_publication_authorization_contract.py",
        20,
    ),
    (
        "controlled draft publication contract",
        ROOT
        / "trust_primitive_engine/tools/"
        "test_controlled_draft_publication_contract.py",
        20,
    ),
    (
    ...
    (
        "preexisting candidate recovery contract",
        ROOT
        / "trust_primitive_engine/tools/"
        "test_preexisting_candidate_recovery_contract.py",
        21,
    ),
    (
